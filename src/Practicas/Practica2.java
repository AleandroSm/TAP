...
public class Practica2 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Integer max = (Integer) jSpinner2.getValue();
        Integer min = (Integer) jSpinner1.getValue();
        if(min >= max){
            JOptionPane.showMessageDialog(null, "limite inferior no puede ser mayor");
        }else{
            int rango = max - min + 1;
            int numGenerado = (int) (Math.random()*rango)+min;
            jTextField1.setText(String.valueOf(numGenerado));
        }
